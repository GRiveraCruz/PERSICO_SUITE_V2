...
function applyPermsToDom(d) {
  ...
  const btnPatterns = [
    // Jobs
    { pat:'openNewJob(',      mod:'jobs',         need:'create' },
    ...
    // Rates
    { pat:'ratesOpenNew(',    mod:'rates',        need:'create' },
    { pat:'ratesImport(',     mod:'rates',        need:'full' },
    // Quotes
    { pat:'openNewQuote(',    mod:'quotes',       need:'create' },
    // CPO
    ...
    { pat:'provImport(',      mod:'proveedores',  need:'full' },
