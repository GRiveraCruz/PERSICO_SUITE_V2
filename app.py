    ...
    for rec in records:
        ...
        for jh in rec.get("jobHours", []):
            ...
            rows.append({
                ...
                "job": job, "horas": jh.get("hours") or 0,
            })
...
def api_asistencia_control_horas():
    ...
    return jsonify({"rows": rows, "reportKey": report_key, "firmas": firmas})
...
MODULES = [
    ...
    # Recursos Humanos
    "rrhh-asistencia", "rrhh-vacaciones", "rrhh-permisos", "rrhh-salario", "rrhh-nomina",
